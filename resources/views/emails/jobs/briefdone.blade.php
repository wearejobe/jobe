...
<br>
<div>The first step of your job "{{ $job->title }}" is progressing according to our Global Metodology.</div>
<br>
<table>
    <tr>
        <td><img src="http://app.wearejobe.com/images/job-stages/brief.png"></td>
        <td><img src="http://app.wearejobe.com/images/job-stages/relation-off.png"></td>
